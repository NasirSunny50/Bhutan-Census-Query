...
where (ta.Request_Service_Id = 13 and ta.App_Approval_Date is not null) 
or (ta.Request_Service_Id = 13 and ta.App_Approval_Date is null and ta.App_Rejection_Date) limit 20